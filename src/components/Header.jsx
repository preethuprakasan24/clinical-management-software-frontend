...
export default function Header() {
  ...
  const { setIsLoginStatus } = React.useContext(isLoginAuthContext);
    ...
    <Box sx={{ width: 250 }} role="presentation" onClick={toggleDrawer(false)}>
      ...
      <List className="mt-4">
        <ListItem disablePadding>
          <ListItemButton className="d-flex justify-content-center align-items-center w-100" style={{height:"100px"}}>
          ...
          <Box sx={{ display: { xs: "none", md: "flex" } }}>
            ...
            {/* <MenuItem>
              <IconButton
                ...
                aria-controls="primary-search-reminder-menu"
                aria-haspopup="true"
                color="inherit"
              >
